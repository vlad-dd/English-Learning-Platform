...
const header = {
    ...
    [HEADER.PROFILE_SIGN_OUT]: "Austragen"
};

const support_panel = {
    [SUPPORT_PANEL.TITLE]: "Unterstützung Panel Team👨‍💻"
};

const GER_TRANSLATION_BUILD = new TranslationBuilder(
    welcome_page, 
    tenses_page, 
    dictionary_page, 
    english_level_page,
