  ...
  <div className="container">
    <div className="row">
      <div className="svg-character">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <g>
            ...
            <g id="planet">
              <circle fill="white" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803"
                r="90.788" />

              <circle id="craterBig" fill="white" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891"
                cy="62.319" r="13.074" />

              <circle id="craterSmall" fill="white" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743"
                cy="158.918" r="7.989" />
              <path id="ring" fill="white" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                stroke-miterlimit="10" d="
			M476.562,101.461c-30.404,2.164-49.691,4.221-49.691,8.007c0,6.853,63.166,12.408,141.085,12.408s141.085-5.555,141.085-12.408
			c0-3.378-15.347-4.988-40.243-7.225" />

              <path id="ringShadow" opacity="0.5" fill="white" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                stroke-miterlimit="10" d="
            ...
            <g id="stars">
              <g id="starsBig">
                <g>
                  ...
                  <line fill="none" stroke="yellow" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                ...
                <g>
                  ...
                  <line fill="yellow" stroke="yellow" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
              ...
              <g id="circlesBig">
                ...
                <circle fill="purple" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
              ...
              <g id="circlesSmall">
                <circle fill="yellow" cx="549.879" cy="296.402" r="2.651" />
                <circle fill="yellow" cx="253.29" cy="229.24" r="2.651" />
                <circle fill="yellow" cx="434.824" cy="263.931" r="2.651" />
                <circle fill="yellow" cx="183.708" cy="544.176" r="2.651" />
                <circle fill="yellow" cx="382.515" cy="530.923" r="2.651" />
                <circle fill="yellow" cx="130.693" cy="305.608" r="2.651" />
                <circle fill="yellow" cx="480.296" cy="477.014" r="2.651" />
              </g>
            </g>
      ...
      <div className="definition">
       ...
       <Link to="/"><Button style={{ border: "1px solid purple", color: "white" }}>HOME</Button></Link>
      </div>
    </div>
  </div>
</main>
